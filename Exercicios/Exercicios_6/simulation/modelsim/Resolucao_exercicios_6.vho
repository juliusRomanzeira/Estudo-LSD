...
-- Design Ports Information
-- O	=>  Location: PIN_L3,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- F[0]	=>  Location: PIN_L1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- F[1]	=>  Location: PIN_K2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- F[2]	=>  Location: PIN_J2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- F[3]	=>  Location: PIN_K1,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF ex_6_3 IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \Mux0~0_combout\ = (!\F[3]~input_o\ & ((\F[0]~input_o\ & (!\F[1]~input_o\ & !\F[2]~input_o\)) # (!\F[0]~input_o\ & (\F[1]~input_o\ $ (\F[2]~input_o\)))))
